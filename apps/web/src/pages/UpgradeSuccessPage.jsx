...
export default function UpgradeSuccessPage() {
  return (
    <AppShell
      ...
      subtitle="Your RankyPulse Pro workspace is ready. Keep the momentum going with a fresh audit."
    >
      <div className="rp-card p-6 text-center">
        ...
        <p className="mt-2 rp-body-small">
          We have unlocked premium reports and automation. A confirmation email is on the way.
        </p>
