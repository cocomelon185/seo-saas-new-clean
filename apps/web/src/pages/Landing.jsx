      ...
      <header className="sticky top-0 z-50 border-b border-white/10 bg-[#120a24]/90 backdrop-blur">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-5 py-4">
          ...
          <div className="flex items-center gap-2">
            <Link to="/auth/signin?provider=google" className="rounded-xl border border-white/10 bg-white/10 px-4 py-2 text-[11px] font-semibold text-white/80 hover:border-white/30 hover:bg-white/20">
              Sign in with Google
            </Link>
