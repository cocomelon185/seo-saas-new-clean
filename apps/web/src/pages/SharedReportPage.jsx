...
export default function SharedReportPage() {
  ...
  const seoTitle = "Shared SEO Audit Report | RankyPulse";
  const seoDescription = report?.url
    ? `Shared SEO audit report for ${report.url}. View issues, quick wins, and priority fixes.`
    : "Shared SEO audit report with issues, quick wins, and priority fixes.";
  ...
  return (
    <>
      <Seo
        ...
        canonical={reportId ? `${base}/r/${reportId}` : undefined}
        robots="index,follow"
      />
